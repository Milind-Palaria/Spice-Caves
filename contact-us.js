...
const navCloseModal =  () => {
  ...
  .contact-us--image {
    ...
    box-shadow: 15px 15px 13px rgba(0, 0, 0, 0.719);
    animation-name: cui;
  ...
  .nav-contact-linker {
    ...
    padding-bottom: 1px; color: rgba(255, 166, 0);
